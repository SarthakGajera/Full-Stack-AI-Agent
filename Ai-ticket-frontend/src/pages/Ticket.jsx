...
const TicketDetailsPage = () => {
    ...
    const fetchTicket = async () => {
      try {
        ...
        if (res.ok) {
          ...
          alert(data.message || "Something went wrong while fetching ticket");
        }
      } catch (err) {
        console.error(err);
      } finally {
  ...
  if (loading) {
    return (
      <div className="text-center mt-10">Loading ticket details page...</div>
    );
  }
          ...
          <>
            ...
            {ticket.relatedSkills?.length > 0 && (
              <p>
                ...
                {ticket.relatedSkills.join(", ")} // this is used to show values
